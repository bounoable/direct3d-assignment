...
void PresetOne::createLights()
{
	...
	gfx->addLight(Light::spot(5.0f, 10.0f, 100.0f, XMFLOAT3(2.5f, 1.5f, -3.25f), XMFLOAT3(-2.5f, -1.5f, 3.25f), _app->randomColor(true)));
	gfx->addLight(Light::spot(8.0f, 10.0f, 80.0f, XMFLOAT3(-1.5f, -0.5f, -2.25f), XMFLOAT3(1.5f, 0.5f, 2.25f), _app->randomColor(true)));
	
	gfx->addLight(Light::spot(15.0f, 20.0f, 400.0f, XMFLOAT3(4.5f, -2.5f, -6.25f), XMFLOAT3(-5.5f, 2.5f, 6.25f), _app->randomColor(true)));
	gfx->addLight(Light::spot(15.0f, 20.0f, 450.0f, XMFLOAT3(-5.5f, 0.25f, -6.25f), XMFLOAT3(6.0f, -0.25f, 6.25f), _app->randomColor(true)));
